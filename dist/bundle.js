...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActionCreator = __webpack_require__(160);
	...
	function getState() {
		return {
			count: _AppStore2.default.getCount()
		};
	}
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ value: this.state.count, onClick: this.handleClick },
						'Increment Count!'
					)
				);
			}
			...
			value: function handleClick(e) {
				_ActionCreator2.default.incrementCount(e.target.value);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActionType = __webpack_require__(165);
	...
	var ActionCreator = (function () {
		...
		_createClass(ActionCreator, null, [{
			key: 'incrementCount',
			value: function incrementCount(value) {
				_Dispatcher2.default.dispatch({
					actionType: _ActionType2.default.INCREMENT,
					payload: value
				});
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_Dispatcher2.default.register(function (payload) {
		...
		switch (action.actionType) {
			case _ActionType2.default.INCREMENT:
